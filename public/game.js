...
function moveDown() {
  if (!currentPiece || gamePaused || gameOver) return;
  dropCounter = Math.max(0, dropCounter - 500);
}
...
function drawPreview() {
  ...
  let centerX = (previewCanvas.width - 60) / 2;
  let centerY = (previewCanvas.height - 60) / 2;
